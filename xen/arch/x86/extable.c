...
static int init_or_live_patch cmp_ex(const void *a, const void *b)
{
...
#ifndef swap_ex
static void init_or_live_patch swap_ex(void *a, void *b, int size)
{
...
void init_or_live_patch sort_exception_table(struct exception_table_entry *start,
