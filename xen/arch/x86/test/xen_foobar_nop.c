...
#ifdef CONFIG_X86
static char foobar_nop_patch_this_fnc[] = "xen_foobar+"BAR_OFFSET"/5";
#else
static char foobar_nop_patch_this_fnc[] = "xen_foobar+"BAR_OFFSET"/4";
#endif
...
struct livepatch_func __section(".livepatch.funcs") livepatch_xen_foobar_nop = {
    ...
    .old_addr = 0, /* Will lookup 'xen_foobar+0x5a/5' */
